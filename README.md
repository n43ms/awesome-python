...
- Orchestration
  ...
  - [anchor](https://github.com/n43ms/Anchor) - Crash-proof AI agent runtime with sub-second OOM/crash recovery from exact failing step. 0 duplicate API calls/Double charges. 
- Vendor Agent SDKs
